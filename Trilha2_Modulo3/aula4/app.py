...
# ==============================
st.title("Chatbot com Memória + RAG – Aula 4")
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [AIMessage(content="Olá! Sou um chatbot com memória e Banco. Como posso ajudar você hoje?")]
